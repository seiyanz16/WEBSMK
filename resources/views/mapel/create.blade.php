...
@error('kompkeahlian') is-invalid @enderror" placeholder="Kompetensi Keahlian" id="kompkeahlian" name="kompkeahlian"
                value="{{old('kompkeahlian')}}" arialabel="Kompetensi Keahlian" aria-describedby="cari" readonly>
...
btn-xs" onclick="pilih('{{$data->id}}', '{{$data->komptensikeahlian}}')" data-dismiss="modal">
                              Pilih
                            </button>
                          </td>
                        </tr>
