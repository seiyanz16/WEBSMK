...
@stop
@section('content')
<form action="{{route('kompkeahlian.store')}}" method="post">
  @csrf
  <div class="row">
    <div class="col-12">
      <div class="card">
...
@error('komptensikeahlian') is-invalid @enderror" id="exampleInputkompkeahlian" placeholder="Kompetensi Keahlian"
              name="komptensikeahlian" value="{{old('komptensikeahlian')}}">
...
@error('standkomp') is-invalid @enderror" placeholder="Standar Kompetensi" id="standkomp" name="standkomp"
                value="{{old('standkomp')}}" arialabel="Standar Kompetensi" aria-describedby="cari" readonly>
